 ...
 */
static inline void
__rb_rotate_set_parents(struct rb_node *old, struct rb_node *newnode,
...
// 	/* Set the parent's pointer to the newnode node last after an RCU barrier
// 	 * so that the pointers onwards are seen to be set correctly when doing
// 	 * an RCU walk over the tree.
// 	 */
// 	__rb_change_child_rcu(victim, newnode, parent, root);
// }
